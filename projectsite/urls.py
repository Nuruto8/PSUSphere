...
from studentorg.views import (
    ...
    CollegeList, CollegeCreateView, CollegeUpdateView, CollegeDeleteView, ChartView, 
    orgMemDoughnutChart, studentCountEveryCollege, radarStudenCountEveryCollege,
    programPolarchart, htmlLegendsChart,
)
